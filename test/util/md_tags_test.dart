...
void main() {
  group('parseTagFile', () {
    test('parses the sample tag file with all block forms', () {
      final result = parseTagFile(_sample('source.tag.md'));
  ...
  group('applyTagBlocks', () {
    test('applies the sample tag file to the sample source (golden)', () {
      final blocks = parseTagFile(_sample('source.tag.md')).blocks;
    ...
    test('splits tag and default at the first pipe', () {
